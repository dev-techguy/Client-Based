...
public class Reseting {
    ...
    private void fetchIPAddress() {
        xampptest.Get();
        addressFound = xampptest.addressFound;
    }
    ...
    public void ResetingSection() {
        ...
        String[] resetype = {"Choose Reset Type", "User Reset"};
...
//        ltype2.addItem("User Reset");
        ...
        ltype2.addActionListener(event -> {
        ...
        FReset.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
